...
Use this for insurance company agency sales channel knowledge bases where
documents are contest/incentive policies and users are sales agents (FCs,
EIMs, ACHs, etc.) asking about eligibility, rewards, thresholds, and timelines.
"""

from policygpt.domain.base import DomainProfile, register
