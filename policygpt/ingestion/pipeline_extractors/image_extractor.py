...
from policygpt.ingestion.pipeline_extractors.base import ExtractedDocument, ExtractedSection, Extractor
...
class ImageExtractor(Extractor):
    ...
    def extract(self, message: IngestMessage) -> ExtractedDocument:
        ...
        return ExtractedDocument(
            title=title,
            sections=[ExtractedSection(title="Image Text", text=ocr_text)],
        )
    ...
    def _get_ocr(self):
        if self._ocr is None:
            from policygpt.ingestion.extraction.ocr import TextractOCR
